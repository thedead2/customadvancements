...
import de.thedead2.customadvancements.util.localisation.TranslationKeyType;
...
public class ModAdvancementProvider extends ForgeAdvancementProvider {
    ...
    public static class ModAdvancementSubProvider implements ForgeAdvancementProvider.AdvancementGenerator {
        ...
        public void generate(HolderLookup.@NotNull Provider registries, @NotNull Consumer<Advancement> saver, @NotNull ExistingFileHelper existingFileHelper) {
            Advancement advancement = withDisplay(Items.ROTTEN_FLESH, "back_to_the_roots", Advancement.Builder.advancement())
                                        .parent(new ResourceLocation("story/root"))
                                        .rewards(new AdvancementRewards.Builder().addExperience(50))
                                        .addCriterion("back_to_the_roots", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity()
                                                                                                                                                   .of(EntityType.ZOMBIE)
                                                                                                                                                   .flags(EntityFlagsPredicate.Builder.flags()
                                                                                                                                                                                      .setIsBaby(false)
                                                                                                                                                                                      .build())
                                                                                                                                                   .build(), DamageSourcePredicate.Builder.damageType()
                                                                                                                                                                                          .direct(EntityPredicate.Builder.entity()
                                                                                                                                                                                                                         .equipment(EntityEquipmentPredicate.Builder.equipment()
                                                                                                                                                                                                                                                                    .mainhand(ItemPredicate.Builder.item()
                                                                                                                                                                                                                                                                                                   .of(Items.ROTTEN_FLESH)
                                                                                                                                                                                                                                                                                                   .build())
                                                                                                                                                                                                                                                                    .build()))))
