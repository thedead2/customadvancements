...
public class FakeAdvancementTab extends GuiComponent {
    private final Minecraft minecraft;
    private final AdvancementGeneratorGUI screen;
    ...
    public FakeAdvancementTab(Minecraft pMinecraft, AdvancementGeneratorGUI pScreen, AdvancementTabType pType, int pIndex, Advancement pAdvancement, DisplayInfo pDisplay) {
        ...
        this.root = new FakeAdvancementWidget(this, pMinecraft, pAdvancement, pDisplay);
        this.addWidget(this.root, pAdvancement);
    }

    public FakeAdvancementTab(Minecraft mc, AdvancementGeneratorGUI screen, AdvancementTabType type, int index, int page, Advancement adv, DisplayInfo info) {
        ...
        if (pAdvancement.getDisplay() != null) {
            for (AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
                if ((pTabIndex % AdvancementTabType.MAX_TABS) < advancementtabtype.getMax()) {
                    return new FakeAdvancementTab(pMinecraft, pScreen, advancementtabtype, pTabIndex % AdvancementTabType.MAX_TABS, pTabIndex / AdvancementTabType.MAX_TABS, pAdvancement, pAdvancement.getDisplay());
                }
    ...
    public void addAdvancement(Advancement pAdvancement) {
        if (pAdvancement.getDisplay() != null) {
            FakeAdvancementWidget advancementwidget = new FakeAdvancementWidget(this, this.minecraft, pAdvancement, pAdvancement.getDisplay());
